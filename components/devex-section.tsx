...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the ViralLookup SDK" },
      { type: "command", text: "npm install @ViralLookup/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx ViralLookup init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@ViralLookup/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@ViralLookup/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to ViralLookup Cloud" },
      { type: "command", text: "ViralLookup deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://agents.ViralLookup.dev/researcher" },
    ],
  },
]
